...
swift-test:
	...
	cd fusefs-swift && SWIFT_TESTING_ENABLED=1 swift build --target OcProtectFsFuseCoreTests
	cd fusefs-swift && SWIFT_TESTING_ENABLED=1 swift test --skip-build --enable-swift-testing --disable-xctest
